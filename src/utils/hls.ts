...
const encodeMaxOriginal = async ({
  ...
  if (isHasAudio) {
    ...
    args.push('-map', '0:0', '-map', '0:0', '-map', '0:0', '-map', '0:0')
  }
  args.push(
    '-s:v:0',
    `${getWidth(720, resolution)}x720`,
  ...
  if (isHasAudio) {
    args.push('v:0,a:0 v:1,a:1 v:2,a:2 v:3,a:3')
  } else {
    args.push('v:0 v:1 v2 v3')
  }
  args.push(
    '-master_pl_name',
    'master.m3u8',
